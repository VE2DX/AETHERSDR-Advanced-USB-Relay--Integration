...
This project will be submitted to AETHERSDR team as a possible evolution of the USB relay interfacing.

# 2- Context

While a great low-cost, simple interface, the Flexradio integration of USB-based relays is lacking some badly needed improvement. Among those;
